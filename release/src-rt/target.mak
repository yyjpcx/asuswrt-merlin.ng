...
export RT-K3 += BUILD_NAME="RT-K3" SWITCH2="" BCM_MMC=n BCM_7114=y NOWL=y NOWLALL=n USBEXTRAS=y ETLAN_LED=7 ROMCFE=n \
		NVSIZE="128" DHDAP=y DPSTA=y BCMFA=n GMAC3=y LACP=y WTFAST=y DWB=y\
		FORCE_SN="380" FORCE_EN="664" USB="USB" DISABLE_REPEATER_UI=n NEWSSID_REV2=y ASUSCTRL=y \
		BW160M=y AHS=n ASD=n BRCM_NAND_JFFS2=n JFFS2LOG=n UBI=y UBIFS=y PSISTLOG=y UUPLUGIN=y SOFTCENTER=y
